...
return require("packer").startup({
	function(use)
		...
		use({
			{ "mfussenegger/nvim-dap", config = require("config.nvim-dap") },
			{ "mfussenegger/nvim-dap-python" },
			{ "leoluz/nvim-dap-go" },
			{ "rcarriga/nvim-dap-ui", config = require("config.dap-ui"), requires = "nvim-neotest/nvim-nio" },
		})
		-- Snippets
		...
		use({
			{ "tpope/vim-dadbod" },
			{ "kristijanhusak/vim-dadbod-ui", config = require("config.vim-dadbod-ui") }
		})
		...
		use({
			...
			end, -- https://github.com/iamcco/markdown-preview.nvim/issues/506
